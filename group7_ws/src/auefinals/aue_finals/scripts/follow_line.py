...
class LineFollower(object):
    ...
    def camera_callback(self, data):
        ...
        crop_img = cv_image[int((height/2)+520):int((height/2)+540)][1:int(width)]
        ...
        p = max(-0.28, min(0.28, ((width/2) - cx)/3000))
        #print("p= {}, cx= {}, (width/2) - cx)/3000= {}".format(p, cx, ((width/2) - cx)/3000))
        
        d = max(-0.28, min(0.28, (cxlast-cx)/(time() - lasttime)*1.2*1e7))
